...
public class SubstitutionIterator implements Iterator<Substitution> {
    ...
    private List<List<String>> valuesForVariables;
    private int[] index; // each in 0 .. vfv[i].size()-1
    private int length;
    private boolean finished;
    
    public SubstitutionIterator(TypedList variables, Map<String, String> universe, TypeHierarchy types) {
    ...
    public Substitution next() {
        ...
        for( int i = length - 1; i >= 0; i-- ) {
            ret.addSubstitution(new Variable(variables.get(i)),
