...
testing to include FF(h$_a$), LAMA, and C$^3$ \todo{citations}. Each of these
...
In the first GIVE test, we construct a series of grid worlds, similar to the one
...
In a real NLG system, where response time is 
