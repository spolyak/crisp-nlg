...
\subfloat[(b) Ordered]{\includegraphics[width=7cm]{data/give2-extracells.pdf}}
  ...
  The vertical axis is the total runtime in seonds.}
...
\subfloat[(b) Ordered]{\includegraphics[width=7cm]{data/give-button-ord.pdf}}
  \caption{Results for the unordered and ordered GIVE domains with a grid size
  of height 20 and width 40. The horizontal axis is the number of buttons $b$.
  The vertical axis is the runtime in seonds.}
