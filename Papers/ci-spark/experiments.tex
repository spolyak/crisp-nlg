...
Fig.~\ref{fig:xtag-graph}. \todo{blah blah talk about results a bit}
...
and it exceeded its memory limit of 16 GB for $n>3$. \todo{blah blah
  talk about what we learn about FF etc}
