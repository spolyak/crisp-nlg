...
One of the few systems uses generative models for sentence generation is {\sc pCru} \newcite{belz2008}. However, her model is defined on possible states of the generation system itself, not on the underlying grammar formalism. 
