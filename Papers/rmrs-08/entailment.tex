...
\begin{thm}\label{thm:big-one}
  ...
  $S'$. \todo{We don't know if this is true for qeq; the proof is
    written for $\dom$.}  \todo{Also note that this is about a version
    of entailment in which $\varphi$ and $\varphi'$ contain the same
    variables, which makes the claim a bit weaker.}
\end{thm}
