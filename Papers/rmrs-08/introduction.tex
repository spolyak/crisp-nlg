...
\newcite{bos:etal:2004} exploit {\sc ccg}'s syntax-semantics
...
Recursion Semantics (\rmrs, \cite{copestake:2003}).  \rmrs\ is a
generalisation of \mrs\ \cite{copestake:etal:2005} that is designed to
...
\newcite{frank:2004} use it to specify semantic components to shallow
...
{\sc mrs} analyses derived from deep grammars, such as the English
