...
and Haddock algorithm and most of its successors
...
comparing the referring expressions (REs) produced by different
approaches to GRE.  In this way, we can organize existing GRE
approaches in an expressiveness hierarchy.  For instance, the
classical Dale and Reiter algorithms compute purely conjunctive
formulas;
\newcite{deemter01:_gener_refer_expres} extends this language by
