...
%However, the system should also be able to make a similar conclusion if a
%user simply does nothing when given the instruction. Thus, such real-time
%plan monitoring is essential in the GIVE domain, and also affects other
