...
of the search problems that arise in NLG quite easily. (Large problem
instances remain a challenge.) On the other hand, these same planners spend
tremendous amounts of time on preprocessing. For instance, FF spends 90\%
of its runtime in the sentence generation domain on grounding out literals
and actions, and ends up slower than our version of GraphPlan that avoids
...
could be improved by grounding more selectively.
