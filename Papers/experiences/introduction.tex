...
We will then discuss some of our experiences using off-the-shelf planners
...
on traditional benchmarks, and in the International Planning
Competition (IPC)---on varying-sized instances of our planning domains. We
also compare these results against an ad-hoc Java implementation of
GraphPlan.  Our findings are mixed. On the one hand, it turns out that
modern planners handle some of the search problems that arise in NLG quite
easily (although large problem instances remain a challenge). On the other
hand, these same planners spend tremendous amounts of time on
