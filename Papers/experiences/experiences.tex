...
to quickly solve many moderately-sized instances of the NLG problems, the
overall planning time is dominated by grounding, rather than search, which
has a pronounced effect on our domains which require relatively short plans
in large universes.




We offer these domains as challenges for the planning community.
\end{abstract}
