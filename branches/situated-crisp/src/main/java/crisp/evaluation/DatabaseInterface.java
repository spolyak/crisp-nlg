...
public abstract class DatabaseInterface {
    ...
    public abstract void writeResults(String resultTableName, int sentenceID, int domainSize, DerivationTree derivation, DerivedTree derivedTree, long creationTime, long preprocessingTime, long searchTime, String error) throws SQLException;
