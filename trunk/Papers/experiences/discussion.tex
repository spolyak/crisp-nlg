...
%has the potential to help---we could gain a lot by only computing
%reachable instances---, but this too is typically done on the grounded
%problem.  \todo{check if this is true} 
